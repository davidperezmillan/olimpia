# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-02-07 11:43
from __future__ import unicode_literals

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import hoor.models_second
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docfile', models.FileField(upload_to=hoor.models_second.user_directory_path)),
            ],
            options={
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quality', models.CharField(choices=[('NR', 'Normal'), ('HD', 'High Definition'), ('VO', 'Version Original'), ('AL', 'Alternativo (Dificil busqueda)')], default='NR', max_length=2)),
